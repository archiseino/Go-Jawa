...
func Prepare(ctx context.Context, db DBTX) (*Queries, error) {
	...
	if q.getAccountForUpdatesStmt, err = db.PrepareContext(ctx, getAccountForUpdates); err != nil {
		return nil, fmt.Errorf("error preparing query GetAccountForUpdates: %w", err)
	}
...
func (q *Queries) Close() error {
	...
	if q.getAccountForUpdatesStmt != nil {
		if cerr := q.getAccountForUpdatesStmt.Close(); cerr != nil {
			err = fmt.Errorf("error closing getAccountForUpdatesStmt: %w", cerr)
		}
	}
...
type Queries struct {
	...
	getAccountForUpdatesStmt *sql.Stmt
...
func (q *Queries) WithTx(tx *sql.Tx) *Queries {
	return &Queries{
		...
		getAccountForUpdatesStmt: q.getAccountForUpdatesStmt,
