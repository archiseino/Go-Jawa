...
// GetAccountForUpdates mocks base method.
func (m *MockStore) GetAccountForUpdates(ctx context.Context, id int64) (sqlc.Account, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "GetAccountForUpdates", ctx, id)
	ret0, _ := ret[0].(sqlc.Account)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}

// GetAccountForUpdates indicates an expected call of GetAccountForUpdates.
func (mr *MockStoreMockRecorder) GetAccountForUpdates(ctx, id any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "GetAccountForUpdates", reflect.TypeOf((*MockStore)(nil).GetAccountForUpdates), ctx, id)
}
...
func (m *MockStore) ListEntries(ctx context.Context, arg sqlc.ListEntriesParams) ([]sqlc.Account, error) {
	m.ctrl.T.Helper()
