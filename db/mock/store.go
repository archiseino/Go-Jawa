...
func (m *MockStore) GetAccountForUpdates(ctx context.Context, id int64) (db.Account, error) {
	m.ctrl.T.Helper()
...
func (m *MockStore) ListEntries(ctx context.Context, arg db.ListEntriesParams) ([]db.Account, error) {
	m.ctrl.T.Helper()
